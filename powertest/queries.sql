...
-- end query 1 in stream 0 using template query1.tpl-- start query 2 in stream 0 using template query2.tpl
with wscs as
 (select sold_date_sk
        ,sales_price
...
-- end query 2 in stream 0 using template query2.tpl-- start query 3 in stream 0 using template query3.tpl
select dt.d_year 
...
-- end query 3 in stream 0 using template query3.tpl-- start query 4 in stream 0 using template query4.tpl
with year_total as (
...
-- end query 4 in stream 0 using template query4.tpl-- start query 5 in stream 0 using template query5.tpl
with ssr as
 (select s_store_id,
...
-- end query 5 in stream 0 using template query5.tpl-- start query 6 in stream 0 using template query6.tpl
...
-- end query 6 in stream 0 using template query6.tpl-- start query 7 in stream 0 using template query7.tpl
select i_item_id, 
...
-- end query 7 in stream 0 using template query7.tpl-- start query 8 in stream 0 using template query8.tpl
select s_store_name
      ,sum(ss_net_profit)
 from store_sales
     ,date_dim
...
-- end query 8 in stream 0 using template query8.tpl-- start query 9 in stream 0 using template query9.tpl
...
-- end query 9 in stream 0 using template query9.tpl-- start query 10 in stream 0 using template query10.tpl
select
  cd_gender,
  cd_marital_status,
  cd_education_status,
...
-- end query 10 in stream 0 using template query10.tpl-- start query 11 in stream 0 using template query11.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- end query 11 in stream 0 using template query11.tpl-- start query 12 in stream 0 using template query12.tpl
select i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
(select avg(quantity*list_price) average_sales
 ...
 limit 100;-- start query 15 in stream 0 using template query15.tpl
...
-- end query 18 in stream 0 using template query18.tpl-- start query 19 in stream 0 using template query19.tpl
...
-- end query 22 in stream 0 using template query22.tpl-- start query 23 in stream 0 using template query23.tpl
...
-- end query 26 in stream 0 using template query26.tpl-- start query 27 in stream 0 using template query27.tpl
...
-- end query 30 in stream 0 using template query30.tpl-- start query 31 in stream 0 using template query31.tpl
...
-- end query 34 in stream 0 using template query34.tpl-- start query 35 in stream 0 using template query35.tpl
...
select i_item_id
 ...
 and d_date between cast('2002-03-29' as date) and (cast('2002-05-28' as date))
...
limit 100;-- start query 39 in stream 0 using template query39.tpl
/*
This query contains multiple, related iterations:
...
-- end query 42 in stream 0 using template query42.tpl-- start query 43 in stream 0 using template query43.tpl
...
-- end query 46 in stream 0 using template query46.tpl-- start query 47 in stream 0 using template query47.tpl
...
-- end query 50 in stream 0 using template query50.tpl-- start query 51 in stream 0 using template query51.tpl
...
-- end query 54 in stream 0 using template query54.tpl-- start query 55 in stream 0 using template query55.tpl
...
-- end query 58 in stream 0 using template query58.tpl-- start query 59 in stream 0 using template query59.tpl
...
-- end query 62 in stream 0 using template query62.tpl-- start query 63 in stream 0 using template query63.tpl
...
-- end query 66 in stream 0 using template query66.tpl-- start query 67 in stream 0 using template query67.tpl
...
ORDER BY lochierarchy DESC ,
         ...
         rank_within_parent
LIMIT 100;
-- end query 70 in stream 0 using template query70.tpl-- start query 71 in stream 0 using template query71.tpl
...
limit 100;select c_last_name
   ...
   (select ss_ticket_number
    ...
    order by cnt desc, c_last_name asc;-- start query 74 in stream 0 using template query74.tpl
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- end query 74 in stream 0 using template query74.tpl-- start query 75 in stream 0 using template query75.tpl
...
-- end query 78 in stream 0 using template query78.tpl-- start query 79 in stream 0 using template query79.tpl
...
-- end query 82 in stream 0 using template query82.tpl-- start query 83 in stream 0 using template query83.tpl
...
select  c_customer_id as customer_id
 ...
 order by c_customer_id
 limit 100;select substr(r_reason_desc,1,20)
       ,avg(ws_quantity)
...
select 
 ...
 order by
   ...
   rank_within_parent 
LIMIT 100;
-- end query 86 in stream 0 using template query86.tpl-- start query 87 in stream 0 using template query87.tpl
...
-- end query 90 in stream 0 using template query90.tpl-- start query 91 in stream 0 using template query91.tpl
...
-- end query 94 in stream 0 using template query94.tpl-- start query 95 in stream 0 using template query95.tpl
...
-- end query 98 in stream 0 using template query98.tpl-- start query 99 in stream 0 using template query99.tpl
